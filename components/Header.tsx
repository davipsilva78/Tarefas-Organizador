  ...
  return (
    <header className="h-20 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 flex items-center justify-between px-4 md:px-8 flex-shrink-0">
      ...
      <div className="flex items-center space-x-2 sm:space-x-4">
         <button onClick={onSearchClick} className="p-2 rounded-full hover:bg-gray-100 dark:hover:bg-gray-700 md:hidden">
          <Icon name="search" className="w-6 h-6 text-gray-600 dark:text-gray-300" />
        </button>
