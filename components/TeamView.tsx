    ...
    return (
        <div>
            <div className="bg-white p-6 rounded-lg shadow-md mb-8">
                <h3 className="text-xl font-bold text-gray-800 mb-4">Adicionar Novo Membro</h3>
                <form onSubmit={handleAddUser} className="flex items-center space-x-4">
                    <input 
                        ...
                        className="flex-grow border-gray-300 rounded-md shadow-sm focus:ring-custom-blue focus:border-custom-blue"
                    />
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
                <h3 className="text-xl font-bold text-gray-800 mb-4">Membros da Equipe ({users.length})</h3>
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                    {users.map(user => (
                        <div key={user.id} className="bg-gray-50 border border-gray-200 rounded-lg p-4 flex flex-col items-center text-center">
                            ...
                            <div className="mt-4 flex space-x-2">
                                <button onClick={() => onEditUser(user)} className="text-xs px-3 py-1 bg-gray-200 text-gray-700 rounded-full hover:bg-gray-300">Editar</button>
