    ...
    <div className="bg-gray-50 border border-gray-200 rounded-lg p-4 flex items-center justify-between">
        <div className="flex items-center">
            ...
            <div className="flex-1">
                <p className="font-semibold text-gray-800">QUANDO <span className="text-custom-blue">{rule.trigger}</span></p>
                <p className="text-gray-600">ENTÃO <span className="text-custom-blue">{rule.action}</span></p>
            </div>
        </div>
  ...
  return (
    <div className="bg-white p-6 rounded-lg shadow-md">
        <div className="flex justify-between items-center mb-6">
            <h3 className="text-xl font-bold text-gray-800">Automações</h3>
        ...
        <p className="text-gray-600 mb-6">Automatize tarefas repetitivas e fluxos de trabalho para economizar tempo e manter tudo organizado.</p>
