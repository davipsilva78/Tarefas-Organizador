    ...
    return (
        <div>
            <div className="bg-white p-4 rounded-lg shadow-md mb-8">
                <h3 className="text-lg font-bold text-gray-800 mb-4">Filtros de Relatório</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    <div>
                        <label className="block text-sm font-medium text-gray-700">Responsável</label>
                        <select value={selectedUserId} onChange={e => setSelectedUserId(e.target.value)} className="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-custom-blue focus:border-custom-blue sm:text-sm rounded-md">
                     ...
                     <div>
                        ...
                        <select value={selectedPriority} onChange={e => setSelectedPriority(e.target.value)} className="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-custom-blue focus:border-custom-blue sm:text-sm rounded-md">
                    ...
                    <div>
                        ...
                        <input type="date" value={dateRange.start} onChange={e => setDateRange(prev => ({...prev, start: e.target.value}))} className="mt-1 block w-full pl-3 pr-1 py-2 text-base border-gray-300 focus:outline-none focus:ring-custom-blue focus:border-custom-blue sm:text-sm rounded-md"/>
                    </div>
                     <div>
                        <label className="block text-sm font-medium text-gray-700">Data de Fim</label>
                        <input type="date" value={dateRange.end} onChange={e => setDateRange(prev => ({...prev, end: e.target.value}))} className="mt-1 block w-full pl-3 pr-1 py-2 text-base border-gray-300 focus:outline-none focus:ring-custom-blue focus:border-custom-blue sm:text-sm rounded-md"/>
                    </div>
                </div>
            </div>
